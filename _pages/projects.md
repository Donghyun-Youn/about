...
|**<u>RF TRx for Capsule Endoscopy</u>** <br> [![chip1](https://donghyun-youn.github.io/about/assets/projects/11_Capsule_Endoscopy.png){: width="200"}](https://donghyun-youn.github.io/about/assets/projects/11_Capsule_Endoscopy.png) <br> | **Collaboration**: Intromedic, South Korea <br> **Design Target**: Low-power high-data-rate communication IC inside the capsule <br> **Architecture**: TX(PLL+PA) & RX(LNA+Mixer+BB Amp.) <br> **Contribution**: <br> 1) 16-QAM 435-MHz power amplifier with <20-ns startup <br> 2) SPI interface (custom-designed) <br> 3) *IEEE ISCAS'21* acceptance with PA <br> 4) KR Patents Granted (No. 10-2624192)|
